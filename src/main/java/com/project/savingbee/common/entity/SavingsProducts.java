...
public class SavingsProducts {
  ...
  private String mtrtInt; // 만기 후 이자율 정책
  ...
  private BigDecimal maxLimit; // 월 가입한도(원)

  private LocalDate dclsStrtDay; // 공시 시작일

  private LocalDate dclsEndDay; // 공시 종료일

  private Boolean isActive; // 활성 상태(공시종료여부)
  ...
  private List<SavingsInterestRates> interestRates; // 적금 금리 정보들
}
